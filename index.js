...
const translations = {
    en: {
        ...
        wheelchaTitle: 'Wheelcha',
        wheelchaDesc: 'A neon 2D physics action rider where you race a wheelchair through ramps, gaps, boosts, and obstacles. Created with Able Studio and available on iOS and Android.',
        vomegleTitle: 'Vomegle',
        vomegleDesc: 'A blind voice arena web game. Read a prompt, hear a challenger, get a voice score, and climb the leaderboard.',
        ...
        foodWontComeTitle: 'DeliveryWontCome',
        foodWontComeDesc: 'A savings simulation app where you virtually order food without paying. Follow the delivery, then see how much money and calories you saved.',
        kBiteTitle: 'K-Bite',
    ...
    ko: {
        ...
        wheelchaTitle: 'Wheelcha',
        wheelchaDesc: '휠체어 라이더가 네온 트랙을 달리며 경사로, 점프, 부스터, 장애물을 돌파하는 2D 물리 액션 라이딩 게임입니다. Able 스튜디오와 합작했으며 iOS와 Android에서 만나볼 수 있습니다.',
        vomegleTitle: 'Vomegle',
        vomegleDesc: '프롬프트를 읽고 상대의 목소리를 들은 뒤 음성 점수를 받아 리더보드에 도전하는 블라인드 보이스 아레나 웹게임입니다.',
        daboTitle: '다보 - 스마트 오답노트',
        daboDesc: 'AI가 문제 내용을 자동 인식하여 스마트 오답노트를 만들어줍니다. 학생들에게 완벽한 학습 도우미!',
        daboRating: '평점 4.5',
        foodWontComeTitle: '배달안와요',
        foodWontComeDesc: '실제 결제 없이 먹고 싶은 음식을 가상으로 주문하고 배달 과정을 체험하는 절약 시뮬레이션 앱입니다. 주문하지 않아 아낀 금액과 칼로리를 확인할 수 있습니다.',
        kBiteTitle: 'K-Bite',
        ...
        inDevelopment: '개발중',
        comingSoon: '출시 예정',
        androidComingSoon: 'Android 출시 예정',
