...
const translations = {
    en: {
        ...
        wheelchaDesc: 'A neon 2D physics action rider where you race a wheelchair through ramps, gaps, boosts, and obstacles. Created with Able Studio. iOS is available now, Android is coming soon.',
    ...
    ko: {
        ...
        wheelchaTitle: 'Wheelcha',
        wheelchaDesc: '휠체어 라이더가 네온 트랙을 달리며 경사로, 점프, 부스터, 장애물을 돌파하는 2D 물리 액션 라이딩 게임입니다. Able 스튜디오와 합작했으며 iOS는 출시, Android는 출시 예정입니다.',
        vomegleTitle: 'Vomegle',
